...
public class BankMenu implements LedgerMenu {
	...
	public Inventory build(Player player) {
		...
		inventory.setItem(11, createBalanceItem(Material.GOLD_INGOT, ChatColor.GOLD + "Carried Balance", moneyService.getCarried(player.getUniqueId())));
		inventory.setItem(15, createBalanceItem(Material.EMERALD, ChatColor.GREEN + "Banked Balance", moneyService.getBanked(player.getUniqueId())));
